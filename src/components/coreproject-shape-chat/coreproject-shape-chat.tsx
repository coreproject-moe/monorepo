...
@Component({
    tag: 'coreproject-shape-chat',
    styleUrl: 'coreproject-shape-chat.css',
    shadow: true,
})
export class CoreprojectShapeChat {
    @Prop() width: string;
    @Prop() height: string;
    @Prop() _style: string;
    ...
    render() {
        return (
            <Host>
                <svg style={css_to_jsx(this?._style)} width={this?.width} height={this?.height} viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
