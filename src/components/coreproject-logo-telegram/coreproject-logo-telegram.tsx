...
@Component({
    tag: 'coreproject-logo-telegram',
    styleUrl: 'coreproject-logo-telegram.css',
    shadow: true,
})
export class CoreprojectLogoTelegram {
    @Prop() width: string;
    @Prop() height: string;
    @Prop() _style: string;
    ...
    render() {
        return (
            <Host>
                <svg style={css_to_jsx(this?._style)} width={this?.width} height={this?.height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                    <defs>
