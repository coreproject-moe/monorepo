...
export class CoreprojectShapeCorner {
    ...
    @Prop() _style: string;
    @Prop() variant: "up-left" | "up-right" | "down-left" | "down-right" | "left-up" | "left-down" | "right-up" | "right-down" = "up-left";
...
<path d="M25 5V13.75C25 15.0761 24.4732 16.3479 23.5355 17.2855C22.5979 18.2232 21.3261 18.75 20 18.75H5" stroke="white" stroke- stroke-linecap="round" stroke-linejoin="round"/>
</svg>
