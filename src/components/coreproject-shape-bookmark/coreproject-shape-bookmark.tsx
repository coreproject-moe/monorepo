...
@Component({
    ...
    styleUrl: 'coreproject-shape-bookmark.css',
    shadow: true,
})
            ...
            <Host>
                <svg ref={el => (this.svg_element = el as SVGElement)} width={this?.width} height={this?.height} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g clip-path="url(#clip0_986_2247)">
                        <path d="M13 10.5835V14.0835" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M11.25 12.3335H14.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <defs>
