...
export class CoreprojectShapeEdit {
    ...
    render() {
            ...
            return (
                <Host>
                    <svg width={this?.width} height={this?.height} style={this?._style} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 15H15.75" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path
        ...
        } else if (this.variant === 'without_underline_around_pencil') {
            return (
                <Host>
                    <svg width={this?.width} height={this?.height} style={this?._style} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
