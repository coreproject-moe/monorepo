...
export class coreprojectShapeBook {
    ...
    render() {
        if (this.variant === "open") { return (<Host><svg :height="height" :width="width" :style="cssToJsx(_style)"   viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
else if (this.variant === "close") { return (<Host><svg :height="height" :width="width" :style="cssToJsx(_style)"   viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
