...
export class CoreprojectShapeShoppingCart {
    ...
    render(){
        return(<Host><svg height={this?.height} width={this?.width} style={css_to_jsx(this?._style)}   viewBox="0 0 38 37" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_583_483)" filter="url(#filter0_d_583_483)">
<path d="M15.25 27.5C15.9404 27.5 16.5 26.9404 16.5 26.25C16.5 25.5596 15.9404 25 15.25 25C14.5596 25 14 25.5596 14 26.25C14 26.9404 14.5596 27.5 15.25 27.5Z" stroke="currentColor" stroke- stroke-linecap="round" stroke-linejoin="round"/>
<path d="M29 27.5C29.6904 27.5 30.25 26.9404 30.25 26.25C30.25 25.5596 29.6904 25 29 25C28.3096 25 27.75 25.5596 27.75 26.25C27.75 26.9404 28.3096 27.5 29 27.5Z" stroke="currentColor" stroke- stroke-linecap="round" stroke-linejoin="round"/>
