		...
		if (this.variant === "open") {
			return (
				<Host>
					...
					>
						<path
							d="M1.25 12C1.25 12 6.25 2 15 2C23.75 2 28.75 12 28.75 12C28.75 12 23.75 22 15 22C6.25 22 1.25 12 1.25 12Z"
							stroke="currentColor"
							stroke-width="3"
						...
						/>
						<path
							d="M15 15.75C17.0711 15.75 18.75 14.0711 18.75 12C18.75 9.92893 17.0711 8.25 15 8.25C12.9289 8.25 11.25 9.92893 11.25 12C11.25 14.0711 12.9289 15.75 15 15.75Z"
							stroke="currentColor"
							stroke-width="3"
							stroke-linecap="round"
							stroke-linejoin="round"
