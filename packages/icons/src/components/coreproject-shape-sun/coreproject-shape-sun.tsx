...
export class CoreprojectShapeSun {
    ...
    render(){
        return(<Host><svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" height={this?.height} width={this?.width} style={css_to_jsx(this?._style)}>
<g clip-path="url(#clip0_583_501)" filter="url(#filter0_d_583_501)">
<path d="M19 21.25C22.4518 21.25 25.25 18.4518 25.25 15C25.25 11.5482 22.4518 8.75 19 8.75C15.5482 8.75 12.75 11.5482 12.75 15C12.75 18.4518 15.5482 21.25 19 21.25Z" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M9.2749 5.2749L11.0499 7.0499" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M26.9502 22.9502L28.7252 24.7252" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M9.2749 24.7252L11.0499 22.9502" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M26.9502 7.0499L28.7252 5.2749" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
