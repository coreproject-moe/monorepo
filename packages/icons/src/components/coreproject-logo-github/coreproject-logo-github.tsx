...
export class CoreprojectLogoGithub {
    ...
    render(){
        return(<Host><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" height={this?.height} width={this?.width} style={css_to_jsx(this?._style)} data-marker='T'>
