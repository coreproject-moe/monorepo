...
@Component({
    tag: 'coreicons-shape-align',
    shadow: true,
    styleUrl: 'coreicons-shape-align.scss'
})
export class CoreiconsShapeAlign {
    ...
    componentWillLoad() {
        if (!['center', 'justify', 'left', 'right'].includes(this.variant))
            throw new Error(
                `'coreicons-shape-align' (${this.variant}) not in ['center', 'justify', 'left', 'right']`
            );
    }
