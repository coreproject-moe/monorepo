			...
			<Host>
				...
				>
					<g filter="url(#filter0_d_583_495)">
						<path
							d="M23.5 2.5H8.5C7.11929 2.5 6 3.61929 6 5V25C6 26.3807 7.11929 27.5 8.5 27.5H23.5C24.8807 27.5 26 26.3807 26 25V5C26 3.61929 24.8807 2.5 23.5 2.5Z"
							stroke="white"
							stroke-
					...
					<defs>
						...
						>
							...
							<feBlend
								mode="normal"
								in="SourceGraphic"
								in2="effect1_dropShadow_583_495"
								result="shape"
							/>
						</filter>
					</defs>
