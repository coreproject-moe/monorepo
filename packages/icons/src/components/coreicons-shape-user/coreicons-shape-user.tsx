...
@Component({
    tag: 'coreicons-shape-user',
    shadow: true,
    styleUrl: 'coreicons-shape-user.scss'
})
export class CoreiconsShapeUser {
    ...
    componentWillLoad() {
        if (!['normal', 'check', 'minus', 'plus', 'x'].includes(this.variant))
            throw new Error(
                `'coreicons-shape-user' (${this.variant}) not in ['normal', 'check', 'minus', 'plus', 'x']`
            );
    }
